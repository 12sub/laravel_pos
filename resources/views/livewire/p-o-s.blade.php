<div class="flex h-screen bg-gray-100 dark:bg-neutral-900 font-sans antialiased text-gray-800 dark:text-gray-100">
                    ...
                    <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg overflow-hidden 
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-700 dark:text-gray-300 mt-1 font-bold">
                                NGN {{ number_format($item->price, 2) }}
                            </p>
                        </div>
                        <button wire:click="addToCart({{ $item->id }})" class="w-full py-3 bg-orange-600 text-white font-bold transition-colors duration-200 
                                                 hover:bg-orange-700 rounded-b-2xl">
                            Add to Cart
                        </button>
                    </div>
                @empty
 ...
 {{-- Right panel --}}
    <div
        class="w-1/3 bg-gray dark:bg-neutral-800 border-l dark:border-neutral-700 p-6 flex flex-col shadow-xl overflow-y-auto">
        ...
        <div class="flex-shrink-0 mt-6 space-y-4">
            <div class="space-y-2">
                <div>
                    ...
                    <select wire:model="customer_id" id="customer" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm 
                            focus:border-blue-500 focus:ring-blue-500 
                            dark:bg-neutral-900 dark:border-neutral-700 
                            dark:text-neutral-900 dark:placeholder-neutral-600 dark:focus:ring-neutral-700">
            ...
            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-neutral-700">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="font-medium text-gray-800 dark:text-gray-100">NGN
